...
#date           :2017-12-10
#version        :0.1
#usage          :bash <(curl -s https://raw.githubusercontent.com/scottnasello/iterm-fish-fisher-osx/master/install.sh)
...
TEMP_DIR=$(mktemp -d)
GITHUB_REPO_URL_BASE="https://github.com/scottnasello/iterm-fish-fisher-osx/"
...
PLUGINS_INSTALLER_URL="https://raw.githubusercontent.com/scottnasello/iterm-fish-fisher-osx/master/install_plugins.sh"
BREWS_INSTALLER_URL="https://raw.githubusercontent.com/scottnasello/iterm-fish-fisher-osx/master/add_brews.sh"
RESET_COLOR="\033[0m"
RED_COLOR="\033[0;31m"
